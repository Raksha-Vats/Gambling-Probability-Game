        ...
        <div>
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <a href="https://github.com/Raksha-Vats" target="_blank">
                <FaGithub size={30} />
              </a>
              <a href="https://www.youtube.com/@RAKSHAKUMARI-q8o" target="_blank">
                <FaYoutube size={30} />
              </a>
              <a href="https://x.com/raksha_vats" target="_blank">
                <FaTwitter size={30} />
              </a>
            </div>
          </div>
